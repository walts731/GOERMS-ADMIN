...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top mb-5">
  ...
  <div class="collapse navbar-collapse mx-5" id="mainNav">
    <ul class="navbar-nav ms-auto">
      <li class="nav-item"><a class="nav-link text-light <?= basename($_SERVER['PHP_SELF']) == 'stud_homepage.php' ? 'active' : '' ?>" href="index.php">Home</a></li>
      <li class="nav-item"><a class="nav-link text-light <?= basename($_SERVER['PHP_SELF']) == 'forms.php' ? 'active' : '' ?>" href="archive.php">Archive</a></li>
      <li class="nav-item"><a class="nav-link text-light <?= basename($_SERVER['PHP_SELF']) == 'forms.php' ? 'active' : '' ?>" href="students.php">Students</a></li>
